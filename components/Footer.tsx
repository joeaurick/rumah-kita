      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-6 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-1 text-gray-300">
              <li>
                <Link href="/blog" className="hover:underline">Artikel Edukasi</Link>
              </li>
              <li>
                <Link href="/panduan" className="hover:underline">Panduan Pembeli</Link>
              </li>
              <li>
                <Link href="/tips-investasi" className="hover:underline">Tips Investasi Properti</Link>
              </li>
            </ul>
          </div>
          <div>
            ...
            <div className="flex space-x-3 mt-2">
              <Link href="https://facebook.com/infoproperti" target="_blank" rel="noopener noreferrer">
                <img src="https://cdn-icons-png.flaticon.com/512/145/145802.png" alt="Facebook" width={24} height={24} />
              </Link>
